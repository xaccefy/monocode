  ...
  return createPortal(
    <div className="fixed inset-0" style={{ zIndex: LAYER.dialog }}>
      ...
      <div
        ...
        className="absolute left-1/2 top-[22%] flex w-[min(420px,calc(100vw-24px))] -translate-x-1/2 flex-col gap-3 rounded-lg border border-content/10 bg-background-base p-4 shadow-xl"
      >
